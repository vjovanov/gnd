...
- **Know what leans on a declaration before you change it.** Before editing, renaming, or moving any declaration, run `gnd refs <ID>` — it lists every citation site, so you update or relocate them in the same change and nothing dangles after.
