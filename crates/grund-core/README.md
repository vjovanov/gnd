...
It contains the scanner, resolver, checker, formatter, config loader, `show`,
`refs`, and shared command dispatcher used by the CLI today, and by the planned
`grund-lsp` server and language bindings later. This package role follows
