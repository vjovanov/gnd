# AS-003-bindings: how the same Rust engine is exposed on three platforms

Implements FS-004-distribution. The repo is a Cargo workspace with one core library and three frontends.
