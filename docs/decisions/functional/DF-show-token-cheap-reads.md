...
- [§GOAL-no-silent-breakage](../../goals/goals.md#goal-no-silent-breakage-changes-ship-through-a-deprecation-path) — additive flags break nothing; the `AGENTS.md` guidance change rides the existing managed-block version mechanism.
