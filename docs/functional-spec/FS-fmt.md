...
The `fmt` subcommand rewrites a tree to canonical form: trigger sequences become markers, and (optionally) bare citations become marker-prefixed. It is the batch counterpart to the live IDE transform from FS-ide-plugins.1.5. Implements DF-reference-marker.
