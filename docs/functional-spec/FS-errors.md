...
- **stdout** is reserved for the command's *result* (e.g. the body printed by `gnd show`). On success with no result to print, stdout is empty per §G-friendliness-first.1.
